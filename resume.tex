...
\begin{EntriesTableDuration}
  ...
  \\ & GPA: 3.95/4.0 Double degree with \TJU, Shanghai, China.
  ...
  \\
  \Duration{2018}{2022}  &
  \textbf{B.Eng}, \HDU, Zhejiang, China.
  \\ & GPA: 4.72/5.0 Ranking: 1/116 \emph{Summa Cum Laude}
  % \\ & Core Courses: Computer Network, Principles of Communication. 
...
\begin{EntriesTableDuration}
  \Duration{2026}{2026}  &
  \textbf{Wireless Network Intern}, VNEXIA, Paris, France.
  \newline  
    Providing wireless backbone to underground infrastructure using Sub-GHz technology.
  \\
  \Duration{2023}{2025}  &
  \textbf{Research Mentor}, Part-time, Chase Education Technology Co., Ltd., Hubei, China.
